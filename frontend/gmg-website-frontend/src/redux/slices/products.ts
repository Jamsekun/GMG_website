  ...
  async (
    ...
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_API_URL}/api/products`,
        {
          params: {
            ...modifiedFilters,
            page: newPage,
...
>("products/fetchProductDetail", async ({ uuid }, { rejectWithValue }) => {
  try {
    const res = await axios.get(
      `${import.meta.env.VITE_REACT_APP_API_URL}/api/products/${uuid}`
    );
...
>("products/createProduct", async ({ formData }, thunkAPI) => {
  try {
    ...
    const url = `${import.meta.env.VITE_REACT_APP_API_URL}/api/products`;
...
>("products/updateProduct", async ({ uuid, formData }, thunkAPI) => {
  try {
    ...
    const url = `${import.meta.env.VITE_REACT_APP_API_URL}/api/products/${uuid}`;
