...
import "rc-slider/assets/index.css"; // ✅ Required for default styling
...
const ListFilter = ({ uuid, items }: ListFilterProps) => {
  return (
    <ul id={uuid} className="flex flex-col gap-3 lg:gap-6 ">
...
export const FilterForm = ({
  ...
  <form className="flex flex-col gap-3 lg:gap-6">
    ...
    <ListFilter uuid="category" items={categoryItems} />
