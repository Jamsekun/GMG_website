...
import Promo1 from "../assets/images/coupon-discount-promotion-png.png";
import Promo2 from "../assets/images/promo-2.webp";
...
const CouponList = () => {
  const promo: PromoData[] = [
    ...
    },
    {
      ...
      description: "Get one of our best selling coffee for free!",
      claimLink: "#",
      bgColor: "bg-green-400",
    },
    {
      imgSrc: Promo1,
      title: "HEROE'S DAY PROMO",
      description: "Get discount on our carwash!",
      claimLink: "#",
      bgColor: "bg-green-400",
    },
    {
    ...
    <div>
      <div className="flex justify-between items-center mx-10 md:mx-32 py-4 md:py-12">
        <div className="text-2xl md:text-5xl">
          Today's <span className="text-amber-800">Promo</span>
        </div>
